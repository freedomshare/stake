...
interface Meland1155PlaceableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setRarity(string,uint256)": FunctionFragment;
...
export class Meland1155Placeable extends BaseContract {
  ...
  interface: Meland1155PlaceableInterface;
