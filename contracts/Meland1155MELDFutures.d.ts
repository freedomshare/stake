...
interface Meland1155MELDFuturesInterface extends ethers.utils.Interface {
  functions: {
    ...
    "futureById(uint256)": FunctionFragment;
    ...
    "totalSupplyByERC20(address)": FunctionFragment;
    ...
    "mintBatch(address,uint256,uint8,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "totalSupplyByERC20",
    values: [string]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "futureById", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getRoleAdmin",
    data: BytesLike
  ): Result;
...
export class Meland1155MELDFutures extends BaseContract {
  ...
  interface: Meland1155MELDFuturesInterface;
  ...
  callStatic: {
    ...
    exchange(id: BigNumberish, overrides?: CallOverrides): Promise<void>;
