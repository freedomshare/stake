...
interface MelandAccessRolesInterface extends ethers.utils.Interface {
  functions: {
...
export class MelandAccessRoles extends BaseContract {
  ...
  interface: MelandAccessRolesInterface;
