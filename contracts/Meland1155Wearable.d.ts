...
interface Meland1155WearableInterface extends ethers.utils.Interface {
  functions: {
...
export class Meland1155Wearable extends BaseContract {
  ...
  interface: Meland1155WearableInterface;
